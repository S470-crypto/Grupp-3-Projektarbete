...
| Admin | Administratör för systemet |
| Parti | Pågående spelsession |
| Spelbrädet | Där spelet pågår. |
| Drag | När det är spelarens tur att placera sin bricka på spelbrädet. |
| Oavgjort | När spelbrädet blir fullt utan att någon spelare har fått fem i rad. |
| Vinst | Spelare får fem brickor i rad och vinner spelet. |
...
| Audit.log | Samtyckes-ID för cookies lagras pseudonymiserat i audit.log |
