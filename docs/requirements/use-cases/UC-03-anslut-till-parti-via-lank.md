...
**Alternativa flöden:**
- A1: Länken är ogiltig/har passerat tidsgränsen.

**Slutvillkor:**
- Båda spelarna (spelare och motståndare) är anslutna till partiet och kan fortsätta spelet genom att gå in i use case "Spela drag". 
