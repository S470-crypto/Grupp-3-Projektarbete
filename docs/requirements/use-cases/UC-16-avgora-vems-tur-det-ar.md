...
## Trigger:
* Ett giltigt drag har precis registrerats i partiet
## Huvudflöde:
...
* Systemet ändrar matchstatus till avslutad istället för att växla spelare
## Eftervillkor:
* Turtillståndet är uppdaterat och konsekvent med antalet spelade drag
* Om partiet avslutades till följd av draget (vinst eller oavgjort) förblir aktiv spelare oförändrad och inga fler drag tillåts
* Det nya tur-tillståndet är synligt för samtliga spelare i partiet
## Testbar avslutning:
