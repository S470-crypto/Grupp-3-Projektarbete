...
## Alternativa flöden
**A1 – Ingen data hittas för angivet ID:** 
- Om dataansvarig inte hittar någon lagrad data kopplad till det angivna session-/länk-ID:t, informeras spelaren om detta utan att en felaktig raderingsbekräftelse visas.

**A2 – Radering begärs för en pågående match:** 
- Om matchen fortfarande pågår aktivt (t.ex. en motspelare är fortsatt inne i matchen vid online-spel), ska motspelaren informeras om att matchen avslutats i förtid på grund av raderingen.
...
## Testbar avslutning
- Efter en genomförd raderingsbegäran finns ingen lagrad speldata kvar kopplad till det angivna session-/länk-ID:t.
- Ett försök att återuppta matchen via samma länk efter radering misslyckas (länken är ogiltig).
- Om ingen data finns för angivet ID visas ett korrekt informationsmeddelande, inte en felaktig raderingsbekräftelse.
- Om spelaren avbryter bekräftelsevyn kvarstår all data helt oförändrad.
- Raderingsåtgärden är loggad (utan att i sig innehålla onödig persondata) för att kunna verifieras vid en eventuell revision.
