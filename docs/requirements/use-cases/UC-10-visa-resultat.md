...
**Meta:**
- Aktör: Spelare (både initierare och motståndare)
- Sekundär aktör: Dator/AI
- Relaterade use cases: UC-01 starta parti mot AI, UC-02 starta parti mot vän och UC-06 spela drag

**Förvillkor:**
- Parti har precis spelats och avgjorts mellan spelare eller mot dator/AI och kommit fram till ett resultat (någon har fått 5 i rad eller så är brädet fullt och det blev oavgjort).
